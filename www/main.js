...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, fcm, router) {
        var _this = this;
        ...
        this.fcm.onNotification().subscribe(function (data) {
            ...
            if (data.wasTapped) {
                ...
                _this.router.navigate([data.landing_page, data.price]);
            }
            else {
...
module.exports = __webpack_require__(/*! /Users/admin/Documents/Projects/live-axity/src/main.ts */"./src/main.ts");
